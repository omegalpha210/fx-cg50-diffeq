...
cases=[
 ...
 ('table-busy','Table preparation: delayed neutral spinner',base+'TICKS:8 F4','Preparing Table... /'),
 ('drawing-busy','Drawing: delayed spinner in preparation strip','2 F6 F6 TICKS:8 F6','Drawing... /'),
